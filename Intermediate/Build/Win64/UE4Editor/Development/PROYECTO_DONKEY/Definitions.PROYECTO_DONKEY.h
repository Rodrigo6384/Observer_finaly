...
#define UE_PROJECT_NAME PROYECTO_DONKEY
#define UE_TARGET_NAME PROYECTO_DONKEYEditor
#define UE_MODULE_NAME "PROYECTO_DONKEY"
...
#define PROYECTO_DONKEY_API DLLEXPORT
